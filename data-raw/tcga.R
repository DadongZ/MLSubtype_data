...
library(readxl)
#LUSC
load(file.path(dir, "TCGA/LUSC/TCGA_LUSC_FPKM.rda"))
...
#lUAD
load(file.path(dir, "TCGA/LUAD/TCGA_LUAD_FPKM.rda"))
...
load(file.path(dir, 'TCGA/BLCA/blca_rsem_normalized_exp.rda'))
blca_edat <- data
...
## HNSC
load(file.path(dir, "TCGA/HNSCC/HNSCtcga_normalized_exp.rda"))
hnsc_edat <- data
...
## STAD
load(file.path(dir, "TCGA/STAD/TCGA_STAD_normalized_exp.rda"))
stad_edat <- data
...
## ESCA
load(file.path(dir, "TCGA/ESCA/TCGA_ESCA_normalized_exp.rda"))
esca_edat <- data
